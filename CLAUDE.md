...
- Todo push vai para a branch `pre-prod` (ambiente de pré-produção). Nunca dar push direto na `main` (produção).
- Remote via SSH: `git@github.com:wsilvad/kisapato_site.git`.
